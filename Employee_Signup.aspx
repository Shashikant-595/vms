...
<asp:ListItem Text="ENGINEERING-1" Value="ENGINEERING-1"></asp:ListItem>
<asp:ListItem Text="ENGINEERING-2" Value="ENGINEERING-2"></asp:ListItem>
<asp:ListItem Text="ENGINEERING-LAB" Value="ENGINEERING-LAB"></asp:ListItem>
<asp:ListItem Text="HR" Value="HR"></asp:ListItem>
<asp:ListItem Text="IT & SAP" Value="IT & SAP"></asp:ListItem>
<asp:ListItem Text="MANUFACTURING_ MAINTENANCE" Value="MANUFACTURING_ MAINTENANCE"></asp:ListItem>
<asp:ListItem Text="MANUFACTURING_ MOULDING" Value="MANUFACTURING_ MOULDING"></asp:ListItem>
<asp:ListItem Text="MANUFACTURING-METALPREP" Value="MANUFACTURING-METALPREP"></asp:ListItem>
<asp:ListItem Text="MANUFACTURING-MIXING" Value="MANUFACTURING-MIXING"></asp:ListItem>
<asp:ListItem Text="MARKETING" Value="MARKETING"></asp:ListItem>
<asp:ListItem Text="PLANT_MANAGEMENT" Value="PLANT_MANAGEMENT"></asp:ListItem>
<asp:ListItem Text="PPC AND DISPATCH" Value="PPC AND DISPATCH"></asp:ListItem>
<asp:ListItem Text="PROCUREMENT" Value="PROCUREMENT"></asp:ListItem>
<asp:ListItem Text="PROJECTS AND IMPROVEMENTS" Value="PROJECTS AND IMPROVEMENTS"></asp:ListItem>
...
<asp:ListItem Text="TOOL ROOM" Value="TOOL ROOM"></asp:ListItem>
                </asp:DropDownList>
