<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Master_Users.aspx.cs" Inherits="Presentation_Layer.Master_Users" %>
...
<body>
                                ...
                                <table align="center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="form-group p-3">
                                            ...
                                            <%--</td>
                                        <td>--%>
                                            <asp:DropDownList ID="cmb_updateuser" CssClass="form-control" runat="server"></asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="form-group text-center p-3">
    ...
    <script>
        function handleButtonClick(action) {
            ...
            if (action === 'save') {
                url = 'Master_Users.aspx?action=save';
            } else if (action === 'edit') {
                url = 'Master_Users.aspx?action=edit';
            }
